...
$adtSession = @{
    ...
    AppProcessesToClose = @(@{ Name = 'explorer'; Description = 'Windows Explorer' })
...
function Install-ADTDeployment
{
    ...
    {
        $msiFile = Get-ChildItem -Path $adtSession.DirFiles -Filter '7z*-x64.msi' | Select-Object -First 1
    }
    else
    {
        $msiFile = Get-ChildItem -Path $adtSession.DirFiles -Filter '7z*-x86.msi' | Select-Object -First 1
    }
