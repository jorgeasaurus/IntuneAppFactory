...
$adtSession = @{
    ...
    AppProcessesToClose = @(
        @{ Name = 'wfica32'; Description = 'Citrix ICA Client' },
        @{ Name = 'Receiver'; Description = 'Citrix Receiver' },
        @{ Name = 'SelfService'; Description = 'Citrix Self-Service' }
    )
...
function Install-ADTDeployment
{
    ...
    $exeFile = Get-ChildItem -Path $adtSession.DirFiles -Filter 'CitrixWorkspaceApp*.exe' | Select-Object -First 1
    Start-ADTProcess -FilePath $exeFile.FullName -ArgumentList '/silent /noreboot /AutoUpdateCheck=disabled'
...
function Uninstall-ADTDeployment
{
    ...
    $adtSession.InstallPhase = $adtSession.DeploymentType
    Uninstall-ADTApplication -Name 'Citrix Workspace'
