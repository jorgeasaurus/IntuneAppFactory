...
function Install-ADTDeployment
{
    ...
    $exeFile = Get-ChildItem -Path $adtSession.DirFiles -Filter 'Git-*-64-bit.exe' | Select-Object -First 1
    Start-ADTProcess -FilePath $exeFile.FullName -ArgumentList '/VERYSILENT /NORESTART /NOCANCEL /SP- /CLOSEAPPLICATIONS /RESTARTAPPLICATIONS /COMPONENTS=ext,ext\shellhere,ext\guihere,gitlfs,assoc,assoc_sh'
...
function Uninstall-ADTDeployment
{
    ...
    $adtSession.InstallPhase = $adtSession.DeploymentType
    Uninstall-ADTApplication -Name 'Git' -NameMatch 'Contains'
