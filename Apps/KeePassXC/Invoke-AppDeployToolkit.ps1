...
$adtSession = @{
    ...
    AppProcessesToClose = @(@{ Name = 'KeePassXC'; Description = 'KeePassXC' })
...
function Install-ADTDeployment
{
    ...
    $msiFile = Get-ChildItem -Path $adtSession.DirFiles -Filter 'KeePassXC-*.msi' | Select-Object -First 1
...
function Uninstall-ADTDeployment
{
    ...
    $adtSession.InstallPhase = $adtSession.DeploymentType
    Uninstall-ADTApplication -Name 'KeePassXC'
