...
$adtSession = @{
    ...
    AppProcessesToClose = @(
        ...
        @{ Name = 'pageant'; Description = 'Pageant' },
        @{ Name = 'plink'; Description = 'Plink' }
    )
...
function Install-ADTDeployment
{
    ...
    $msiFile = Get-ChildItem -Path $adtSession.DirFiles -Filter 'putty-*.msi' | Select-Object -First 1
...
function Uninstall-ADTDeployment
{
    ...
    $adtSession.InstallPhase = $adtSession.DeploymentType
    Uninstall-ADTApplication -Name 'PuTTY'
