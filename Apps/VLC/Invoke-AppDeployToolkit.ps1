...
function Install-ADTDeployment
{
    ...
    $msiFile = Get-ChildItem -Path $adtSession.DirFiles -Filter 'vlc-*-win64.msi' | Select-Object -First 1
...
function Uninstall-ADTDeployment
{
    ...
    $adtSession.InstallPhase = $adtSession.DeploymentType
    Uninstall-ADTApplication -Name 'VLC media player' -NameMatch 'Contains'
