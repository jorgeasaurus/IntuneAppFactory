...
$adtSession = @{
    ...
    AppProcessesToClose = @(@{ Name = 'Code'; Description = 'Visual Studio Code' })
...
function Install-ADTDeployment
{
    ...
    $exeFile = Get-ChildItem -Path $adtSession.DirFiles -Filter 'VSCode*.exe' | Select-Object -First 1
    Start-ADTProcess -FilePath $exeFile.FullName -ArgumentList '/VERYSILENT /NORESTART /MERGETASKS=!runcode,addcontextmenufiles,addcontextmenufolders,addtopath'
...
function Uninstall-ADTDeployment
{
    ...
    $adtSession.InstallPhase = $adtSession.DeploymentType
    Uninstall-ADTApplication -Name 'Microsoft Visual Studio Code' -NameMatch 'Contains'
