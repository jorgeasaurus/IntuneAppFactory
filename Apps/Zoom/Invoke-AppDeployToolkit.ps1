...
$adtSession = @{
    AppVendor = 'Zoom Video Communications'
    ...
    AppProcessesToClose = @(@{ Name = 'Zoom'; Description = 'Zoom Workplace' })
...
function Install-ADTDeployment
{
    ...
    $msiFile = Get-ChildItem -Path $adtSession.DirFiles -Filter 'Zoom*.msi' | Select-Object -First 1
    Start-ADTMsiProcess -Action Install -FilePath $msiFile.Name -ArgumentList 'ALLUSERS=1 ZoomAutoUpdate=1'
...
function Uninstall-ADTDeployment
{
    ...
    $adtSession.InstallPhase = $adtSession.DeploymentType
    Uninstall-ADTApplication -Name 'Zoom' -NameMatch 'Contains'
